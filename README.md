...
This recommendation system can also be biased due to the data used. In the case of Spotify and other song recommendation systems, the data would be the song catalogue which may favor popular genres and underrepresent niche genres. As a result, users who like those niche genres will get worse recommendations overall compared to users who like the popular genres.